...
public class Catalogue {
  ...
  private static final String cisp2modMetaDataFileName = PropertiesUtil.getProperties("cisp2modMetaDataFileName");
  private static final String CISP2DCatMetaDataFileName = PropertiesUtil.getProperties("CISP2DCatMetaDataFileName");
  private static final String cladimedmodMetaDataFileName = PropertiesUtil.getProperties("cladimedmodMetaDataFileName");
  private static final String cladimedDCatMetaDataFileName = PropertiesUtil.getProperties("cladimedDCatMetaDataFileName");
