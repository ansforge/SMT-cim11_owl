...
public class CIM11ModMetadata {

  private static final String cim11modMetaDataFileName = PropertiesUtil.getProperties("cim11modMetaDataFileName");
...
//    final InputStream in = new FileInputStream(owlFileName);
    final OutputStream fileoutputstream = new FileOutputStream(cim11modMetaDataFileName);
...
man.addAxiom(onto, declarationAxiom);
  ...
  public static void addTerminologie() {
    ...
    final OWLAnnotation labelAnno11 =
        fact.getOWLAnnotation(dctLanguage, IRI.create(MetadataUtil.getProperties("terminologie_language_en", "ICD11"), "en"));
    ...
    final OWLAnnotation labelAnno12 =
        fact.getOWLAnnotation(dctLanguage, IRI.create(MetadataUtil.getProperties("terminologie_language_fr", "ICD11"), "fr"));
    ...
    for(String vocab : MetadataUtil.getProperties("terminologie_vocabularyUsed", "ICD11").split(";")) {
    ...
    for(String vocab : MetadataUtil.getProperties("terminologie_hierarchyProperty", "ICD11").split(";")) {
      final OWLAnnotation labelAnno2a =
