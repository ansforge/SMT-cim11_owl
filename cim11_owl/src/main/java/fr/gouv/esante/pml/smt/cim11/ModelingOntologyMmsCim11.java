  ...
  public static void uriVersionningModeling() {
	  ...
	  onto.axioms().filter(ax -> ax.isOfType(AxiomType.DECLARATION)).
	    forEach(ax -> {
	    	...
	    	OWLClass owlClass = fact.getOWLClass(IRI.create(iri.replace("release/11/2026-01/mms", "release/11/mms")));
...
//	    	System.out.println(ax);
	    ...
	    forEach(ax -> {
			...
			OWLClass disjClass = fact.getOWLClass(IRI.create(firstIRI.replace("release/11/2026-01/mms", "release/11/mms")));
			OWLClass owlClass = fact.getOWLClass(IRI.create(secondIRI.replace("release/11/2026-01/mms", "release/11/mms")));
	    ...
	    forEach(ax -> {
	    	...
	    	if(firstIRI.contains("release/11/2026-01/mms")) {
	    ...
	    forEach(ax -> {
	    	String iriSub = ((OWLSubClassOfAxiom) ax).getSubClass().asOWLClass().getIRI().getIRIString().replace("release/11/2026-01/mms", "release/11/mms");
	    	String iriSup = ((OWLSubClassOfAxiom) ax).getSuperClass().asOWLClass().getIRI().getIRIString().replace("release/11/2026-01/mms", "release/11/mms");
	    ...
	    onto.axioms().filter(ax -> ax.isOfType(AxiomType.SUBCLASS_OF)).
	    forEach(ax -> {
	    	if(((OWLSubClassOfAxiom) ax).getSubClass().asOWLClass().getIRI().getIRIString().contains("release/11/2026-01/mms")) {
    			manager.applyChange(new RemoveAxiom(onto, ax));
    		}
	      });
	    ...
	    forEach(ax -> {
	    	if(((OWLAnnotationAssertionAxiom) ax).getProperty().toString().equals("<http://www.w3.org/2004/02/skos/core#narrower>")) {
    			...
    			OWLAnnotation annot1 = fact.getOWLAnnotation(((OWLAnnotationAssertionAxiom) ax).getProperty(), IRI.create(((OWLAnnotationAssertionAxiom) ax).getValue().toString().replace("release/11/2026-01/mms", "release/11/mms")));
        		OWLAxiom axiom1 = fact.getOWLAnnotationAssertionAxiom(IRI.create(((OWLAnnotationAssertionAxiom) ax).getSubject().toString().replace("release/11/2026-01/mms", "release/11/mms")), annot1);
	    		...
	    		OWLAxiom axiom = fact.getOWLAnnotationAssertionAxiom(IRI.create(((OWLAnnotationAssertionAxiom) ax).getSubject().toString().replace("release/11/2026-01/mms", "release/11/mms")), annot);
	    		...
	    		OWLAxiom axiom2 = fact.getOWLAnnotationAssertionAxiom(IRI.create(((OWLAnnotationAssertionAxiom) ax).getSubject().toString().replace("release/11/2026-01/mms", "release/11/mms")), annot2);
    			...
    			if(((OWLAnnotationAssertionAxiom) ax).getValue().toString().contains("chapter")) {
    		    	...
    		    	String iriSub = ((OWLAnnotationAssertionAxiom) ax).getSubject().toString().replace("release/11/2026-01/mms", "release/11/mms");
	    		...
	    		OWLAnnotation annot2 = fact.getOWLAnnotation(((OWLAnnotationAssertionAxiom) ax).getProperty(), IRI.create(((OWLAnnotationAssertionAxiom) ax).getValue().toString().replace("release/11/2026-01/mms", "release/11/mms")));
	    		OWLAxiom axiom2 = fact.getOWLAnnotationAssertionAxiom(IRI.create(((OWLAnnotationAssertionAxiom) ax).getSubject().toString().replace("release/11/2026-01/mms", "release/11/mms")), annot2);
	    		manager.applyChange(new AddAxiom(onto, axiom2));
...
//	    		manager.applyChange(new AddAxiom(onto, axiom));
	    ...
	    onto.axioms().filter(ax -> ax.isOfType(AxiomType.ANNOTATION_ASSERTION)).
	    forEach(ax -> {
	    		if(((OWLAnnotationAssertionAxiom) ax).getSubject().toString().contains("release/11/2026-01/mms")) {
	    			manager.applyChange(new RemoveAxiom(onto, ax));
	    ...
	    forEach(ax -> {
	    	ax.classesInSignature().findFirst().ifPresent(clacc -> {
		    	String iri = clacc.getIRI().getIRIString();
		    	if(iri.contains("release/11/2026-01/mms")) {
	    			manager.applyChange(new RemoveAxiom(onto, ax));
	    		}
		    	});
