...
public class SetICDLabelTraductionRU {
  ...
  private static String labelsFileName = PropertiesUtil.getProperties("labelsFileNameRU");
  private static OWLDataFactory fact = null;
  static InputStream input = null;
  
  public static void main(final String[] args) throws Exception {
    
    input = new FileInputStream(owlFileNameAR);
    ...
    final OutputStream fileoutputstream = new FileOutputStream(owlFileNameRU);
