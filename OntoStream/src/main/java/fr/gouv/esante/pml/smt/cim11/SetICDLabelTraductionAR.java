...
public class SetICDLabelTraductionAR extends SetICDLabelTraduction {
  
  
  private static String owlFileNameES = PropertiesUtil.getProperties("owlFileNameES");
  private static String owlFileNameAR = PropertiesUtil.getProperties("owlFileNameAR");
  private static String labelsFileName = PropertiesUtil.getProperties("labelsFileNameAR");
  private static OWLDataFactory fact = null;
  static InputStream input = null;
  
  public static void main(final String[] args) throws Exception {
    
    input = new FileInputStream(owlFileNameES);
    ...
    final OutputStream fileoutputstream = new FileOutputStream(owlFileNameAR);
