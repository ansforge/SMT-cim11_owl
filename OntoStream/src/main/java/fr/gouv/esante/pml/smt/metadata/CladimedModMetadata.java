...
public class CladimedModMetadata {
...
//    final InputStream in = new FileInputStream(owlFileName);
    final OutputStream fileoutputstream = new FileOutputStream(cladimedmodMetaDataFileName);
...
//        config.setMissingImportHandlingStrategy(MissingImportHandlingStrategy.SILENT));
    ...
    onto = man.createOntology(IRI.create(MetadataUtil.getProperties("terminologie_profil_IRI", "CLADIMED")));
...
//  }
  ...
  public static void addTerminologie() {
    terminologie = fact.getOWLNamedIndividual(IRI.create(MetadataUtil.getProperties("terminologie_IRI", "CLADIMED")));
    OWLDeclarationAxiom declarationAxiom = fact
    ...
    final OWLAnnotation labelAnno11 =
        fact.getOWLAnnotation(dctLanguage, IRI.create(MetadataUtil.getProperties("terminologie_language_en", "CLADIMED"), "en"));
    ...
    final OWLAnnotation labelAnno12 =
        fact.getOWLAnnotation(dctLanguage, IRI.create(MetadataUtil.getProperties("terminologie_language_fr", "CLADIMED"), "fr"));
    ...
    for(String vocab : MetadataUtil.getProperties("terminologie_vocabularyUsed", "CLADIMED").split(";")) {
    ...
    for(String vocab : MetadataUtil.getProperties("terminologie_hierarchyProperty", "CLADIMED").split(";")) {
      final OWLAnnotation labelAnno2a =
...
//    
  ...
  public static void addIRIAxioms(OWLAnnotationProperty prop, String iri) {
    final OWLAnnotation annotation =
        fact.getOWLAnnotation(prop, IRI.create(MetadataUtil.getProperties(iri, "CLADIMED")));
  ...
  public static void addLateralAxioms(OWLAnnotationProperty prop, String iri) {
    final OWLAnnotation annotation =
        fact.getOWLAnnotation(prop, fact.getOWLLiteral(MetadataUtil.getProperties(iri, "CLADIMED")));
    final OWLAxiom axiom = fact.getOWLAnnotationAssertionAxiom(terminologie.getIRI(), annotation);
    man.applyChange(new AddAxiom(onto, axiom));
  }
  ...
  public static void addLateralAxioms(OWLAnnotationProperty prop, String iri,  OWL2Datatype datatype) {
    final OWLAnnotation annotation =
        fact.getOWLAnnotation(prop, fact.getOWLLiteral(MetadataUtil.getProperties(iri, "CLADIMED"), datatype));
    final OWLAxiom axiom = fact.getOWLAnnotationAssertionAxiom(terminologie.getIRI(), annotation);
    man.applyChange(new AddAxiom(onto, axiom));
  }
  ...
  public static void addLateralAxioms(OWLAnnotationProperty prop, String iri, String lang) {
    final OWLAnnotation annotation =
        fact.getOWLAnnotation(prop, fact.getOWLLiteral(MetadataUtil.getProperties(iri, "CLADIMED"), lang));
    final OWLAxiom axiom = fact.getOWLAnnotationAssertionAxiom(terminologie.getIRI(), annotation);
    man.applyChange(new AddAxiom(onto, axiom));
  }
