...
//                continue;
//              } else if (reader.getLocalName().equals("code")
          ...
          switch (event) {
            case XMLStreamConstants.START_ELEMENT:
              ...
              if (localName.equals("prefLabel")) {
                ...
                reader.next();
                concept.addCode(reader.getText());
                continue;
              }else if (localName.equals("classKind")) {
                reader.next();
                concept.addClassKind(reader.getText());
                continue;
              }else if (localName.equals("codingHint") && (reader.getAttributeCount() > 0)
                  && (reader.getAttributeValue(this.rdfNs, "resource") != null)) {
                reader.next();
                concept.addCodingHint(reader.getText());
                continue;
              } else if (localName.equals("broaderTransitive")) {
                ...
                continue;
              } else if (localName.equals("codingNote") ) {

                concept.addCodingNote(reader.getElementText());
                continue;
                ...
                reader.next();
                concept.addReleaseDate(reader.getText());
                continue;
                ...
                continue;
              } else if (localName.equals("browserUrl")) {
                reader.next();
                concept.addBrowserUrl(reader.getText());
                continue;
              }
            case XMLStreamConstants.END_ELEMENT:
              if (reader.getLocalName().equals("Description")) {
